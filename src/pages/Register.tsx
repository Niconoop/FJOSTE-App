    ...
    <div className="min-h-screen relative flex items-center justify-center p-6 bg-[#000000]">
      ...
      <div className="absolute top-0 left-0 right-0 h-16 z-20 flex justify-end items-center px-6">
        ...
        <div className="flex items-center gap-1">
          <button
            onClick={() => { console.log('Register.tsx: Minimieren geklickt'); try { (window as any).electronAPI.minimizeWindow() } catch (e) { console.error(e) } }}
          ...
          <button
            onClick={() => { console.log('Register.tsx: Maximieren geklickt'); try { (window as any).electronAPI.maximizeWindow() } catch (e) { console.error(e) } }}
            className="p-2 text-slate-500 hover:text-white hover:bg-white/5 rounded-lg transition-all"
            title="Vollbild"
          >
            <Square size={16} />
          ...
          <button
            onClick={() => { console.log('Register.tsx: Schließen geklickt'); try { (window as any).electronAPI.closeWindow() } catch (e) { console.error(e) } }}
